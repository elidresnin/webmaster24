    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <RotatingCard>
            <RotatingCardFront
              image="https://www.cnet.com/a/img/resize/bbcdbdb37048b08b6a0b14975c9ea5fc4041b7f5/hub/2022/10/10/f2ff9ef7-f016-459d-b88a-a8a68270c315/solar-gettyimages-525206743.jpg?auto=webp&fit=crop&height=1200&width=1200"
              icon="touch_app" title="Solar <br /> Energy"
              description="Our most popular sustainable option for urban areas." />

           

            <div class="back back-background" :style="{
              backgroundImage: `url(https://www.cnet.com/a/img/resize/bbcdbdb37048b08b6a0b14975c9ea5fc4041b7f5/hub/2022/10/10/f2ff9ef7-f016-459d-b88a-a8a68270c315/solar-gettyimages-525206743.jpg?auto=webp&fit=crop&height=1200&width=1200)`,
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <RotatingCard>
            <RotatingCardFront
              image="https://upload.wikimedia.org/wikipedia/commons/b/ba/Windmills_D1-D4_%28Thornton_Bank%29.jpg"
              icon="touch_app" title="Wind <br /> Energy"
              description="Use the power of the wind to transform your life and protect the earth" />
          ...
          <div class="back back-background" :style="{
              ...
              <div class="card-body pt-7 text-center">
                ...
                <p class="text-white opacity-8">
                  We guide homeowners through the exciting realm of wind power, offering insights and resources to seamlessly integrate this renewable energy source into their lives. Take a step towards sustainability – let the winds of change fuel your home's energy transformation for a greener tomorrow.
                </p>
                <div class="buttons-group">
                  <RouterLink to="/pages/solutions/wind">
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <RotatingCard>
            <RotatingCardFront
              ...
              icon="touch_app" title="Geothermal <br /> Energy"
              description="Take advantage of the heat buried beneath the Earth's surface to lead a sustainable life." />

            
              <div class="back back-background" :style="{
              backgroundImage: `url(https://www.thecooldown.com/wp-content/uploads/2022/09/AQZw0Us0FzycQ941sZ5n-GeFjqY7ZWOik6DRAZr2sI8-1.jpg)`,
              backgroundSize: 'cover',
            }">
              <div class="card-body pt-7 text-center">
                <h3 class="text-white" >Geothermal</h3>
                <p class="text-white opacity-8">
