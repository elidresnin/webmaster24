...
<template>
  <nav class="navbar navbar-expand-lg top-0" :class="{
    ...
    <div :class="props.transparent || props.light || props.dark
      ...
      ]" :to="{ name: 'presentation' }" rel="tooltip" title="m" data-placement="bottom">
        <div class="">
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <li class="nav-item dropdown dropdown-hover mx-2">
            <RouterLink class="nav-link ps-2 d-flex cursor-pointer align-items-center" :class="[
              (props.transparent && textDark.value) || !props.transparent
                ? 'text-dark  ms-sm-4'
                : 'text-white ms-sm-4'
                ...
                <ul class="list-group">
                  <li class="nav-item list-group-item border-0 p-0">
                    <RouterLink class="navbar-brand d-none d-md-block" :class="[
                      ...
                      <span class="text-sm text-dark">Explore the most common Green Energy solution.</span>
                    </RouterLink>
                  </li>
                  <li class="nav-item list-group-item border-0 p-0">
                    <RouterLink class="navbar-brand d-none d-md-block" :class="[
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <RouterLink class="btn btn-sm mb-0" :class="action.color" :to="action.route" rel="tooltip" title=""
              data-placement="bottom">
              {{ action.label }}
            </RouterLink>
